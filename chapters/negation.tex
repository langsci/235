...
\ea\label{eng}
{\ili{English} \citep[9]{Jespersen1917}}\\
...
\ea\label{fr}
{\ili{French} \citep[7]{Jespersen1917}}\\
...
\ea\label{med}
{       \ili{Medieval} \ili{French} (\citealt{Hansen2013}: 72; \citealt{Buridant2000}: 610)} \\
...
Note that a similar element \textit{śī} [ɬiː], with the same \isi{existential} function, is found in the Modern \ili{South Arabian} languages (\ili{MSAL}) of \isi{Yemen} and \ili{Oman}, as in \REF{meh}, from \ili{Mehri} of \isi{Yemen}.
...
The \ili{Kumzari} negator is the typical \ili{Iranian} (and Indo-\ili{Iranian}) \textit{na}. What is less typical is that \textit{na} occurs postverbally in \ili{Kumzari}, as shown in \REF{kum}.
