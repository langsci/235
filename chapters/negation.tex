...
For the vast majority of \ili{Arabic} varieties the answer is a clear no: these varieties straightforwardly belong to Type A of Croft’s typology. The verbal negator (\textit{mā}, \textit{mā…-š}, or \textit{{}-š}) is also used to negate \isi{existential} predicates, as illustrated in \REF{cair} for \ili{Cairo} \ili{Arabic}.\pagebreak\largerpage[2]
