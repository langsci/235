...
The normal equivalent to the 〈{\arabscript{ق}}〉 of Classical Arabic is the velar stop /g/, as in other bedouin dialects (e.g. \textit{bagra} ‘cow’, CA \textit{baqara}). However, /q/ is in no way rare.
