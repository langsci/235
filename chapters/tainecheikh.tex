...
\subsubsection{The consonant /ḍ/} %3.1.1.1. / 
...
\subsubsection{ The consonant /ẓ/} %3.1.1.2. / 
...
\subsubsection{ The consonant /q/} %3.1.1.3. / 
...
\subsubsection{ Glottal stop} %3.1.1.4. / 
...
\subsubsection{ Palatalized consonants/} %3.1.1.5. / 
...
\subsubsection{ Labial and labiovelar conosonants} %3.1.1.6. / 
...
\subsubsubsection{ The Derivation of \textit{sa-} } %3.2.2.1. /
...
\subsubsubsection{ \textit{Wanderwörter}} %3.4.2.1. /
...
@article{Aguadé1998,
	author = {Aguadé, Jordi},
	journal = {\textit{Estudios} \textit{de} \textit{Dialectología} \textit{Norteafricana} \textit{y} \textit{Andalusí}},
	pages = {203–215},
	sortname = {Aguade, Jordi},
	title = {Relatos en hassaniyya recogidos en Mħāmīd (Valle del Dra, Sur de Marruecos)},
	volume = {3},
	year = {1998}
}
...
@book{Cantineau1960,
	address = {\textit{Études} \textit{de} \textit{linguistique} \textit{arabe:} \textit{Mémorial} \textit{Jean} \textit{Cantineau}, 1–125. Paris},
	author = {Cantineau, Jean},
	publisher = {Klincksieck},
	title = {Cours de phonétique arabe},
	year = {1960}
}
...
@book{Clauzel1960,
	...
	title = {\textit{L’exploitation} \textit{des} \textit{salines} \textit{de} \textit{Taoudenni}},
	year = {1960}
}
...
@book{Cohen1963,
	...
	author = {Cohen, David},
	publisher = {Klincksieck},
	title = {\textit{{Le}} \textit{dialecte} \textit{arabe} ḥassānīya \textit{de} \textit{Mauritanie}},
	year = {1963}
}
...
@book{Cohen1924,
	...
	title = {\textit{{Le}} \textit{système} \textit{verbal} \textit{sémitique} \textit{et} \textit{l’expression} \textit{du} \textit{temps}},
	year = {1924}
}
...
@incollection{Dia2007,
	...
	pages = {325–344},
	publisher = {Routledge},
	title = {Uses and attitudes towards {Hassaniyya} among Nouakchott’s Negro-Mauritanian population},
	year = {2007}
}
...
@book{Diagana2013,
	...
	publisher = {Karthala},
	title = {\textit{Dictionnaire} \textit{soninké-français} \textit{(Mauritanie)}},
	year = {2013}
}
...
@book{Heath2002,
	...
	publisher = {Routledge},
	title = {\textit{{Jewish}} \textit{and} \textit{Muslim} \textit{dialects} \textit{of} \textit{Moroccan} \textit{{Arabic}}},
	year = {2002}
}
...
@book{Heath2004,
	...
	title = {\textit{Hassaniya} \textit{{Arabic}} \textit{({Mali})–{English}–{French}} \textit{Dictionary}},
	year = {2004}
}
...
@book{Jacques-Meunié1961,
	...
	title = {\textit{Cités} \textit{anciennes} \textit{de} \textit{Mauritanie}},
	year = {1961}
}
...
@incollection{Monteil1939,
	...
	booktitle = {\textit{Contributions} \textit{à} \textit{l’étude} \textit{du} \textit{Sahara} \textit{occidental}},
...
@book{Monteil1952,
	...
	title = {\textit{Essai} \textit{sur} \textit{le} \textit{chameau} \textit{au} \textit{Sahara} \textit{{Occidental}}},
	year = {1952}
}
...
@incollection{OuldMohamedBaba2003,
	...
	booktitle = {\textit{{AIDA}} \textit{5th} \textit{Conference} \textit{Proceedings} \textit{(Cádiz,} \textit{\citealt{September2002})}},
...
@book{Paciotti2017,
	address = {La situazione della Ḥassāniyya nella regione di Guelmime-Oued Noun. Naples},
	author = {Paciotti, Luca},
	publisher = {Università degli Studi di Napoli “L’Orientale” Masters},
	title = {Conflitti linguistici e glottopolitica in Marocco},
	year = {2017}
}
...
@book{Taine-Cheikh1988,
	address = {Paris},
	author = {Taine-Cheikh, Catherine},
	publisher = {Geuthner},
	title = {\textit{Dictionnaire} \textit{ḥassāniyya–français}},
	year = {1988}
}
...
@article{Taine-Cheikh1997,
	author = {Taine-Cheikh, Catherine},
	journal = {\textit{Peuples} \textit{méditerranéens}},
	pages = {85–102},
	title = {Les hassanophones du Maroc: {{{E}}}ntre affirmation de soi et auto-reniement},
	volume = {79},
	year = {1997b}
}
...
@incollection{Taine-Cheikh2003,
	...
	pages = {103–118},
	publisher = {Universidad de Cádiz, Servicio de Publicaciones},
	title = {Les valeurs du préfixe \textit{s-} en hassaniyya et les conditions de sa grammaticalisation},
	year = {2003}
}
...
@article{Taine-Cheikh2004,
	author = {Taine-Cheikh, Catherine},
	journal = {Réflexions pour une typologie. \textit{Estudios} \textit{de} \textit{Dialectología} \textit{Norteafricana} \textit{y} \textit{Andalusí}},
	pages = {215–238},
	title = {{Le}(s) futur(s) en arabe},
	volume = {8},
	year = {2004}
}
...
@book{Taine-Cheikh2008,
	address = {\textit{Berber} \textit{in} \textit{contact:} \textit{Linguistic} \textit{and} \textit{sociolinguistic} \textit{perspectives}, 113–138. Cologne},
	author = {Taine-Cheikh, Catherine},
...
@book{Taine-Cheikh2008,
	...
	author = {Taine-Cheikh, Catherine},
	publisher = {Rüdiger Köppe},
	title = {\textit{Dictionnaire} \textit{zénaga–français.} \textit{{Le}} \textit{berbère} \textit{de} \textit{Mauritanie} \textit{par} \textit{racines} \textit{dans} \textit{une} \textit{perspective} \textit{comparative}},
	year = {2008b}
}
