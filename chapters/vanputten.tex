...
\citet{Nöldeke1910} contains an important section on {loanwords} both from \ili{Arabic} to the \ili{Ethio-Semitic} languages and the other way around.\\
