...
\item[\adfhalfrightarrowhead]\ili{Arabic} and \ili{Indo-Iranian} languages: Asbaghi \citet{Asbaghi2011}, \citet{Tsabolov1994}, \citet{Matras2007Domari}, \citet{Gazsi2011}, \citet{WalAnonby2015}, \citet{Herin2018}.
...
Despite these descriptive gaps, the twenty-nine chapters included in the present volume collectively have the merit of discussing a wide range of contact situations involving \ili{Arabic} (balanced {bilingualism}, unbalanced {bilingualism}, pidginization and creolization), which cover a broad geographical area and lengthy timespan, thus giving a close-to-comprehensive picture of the currently known facts of \ili{Arabic} and contact-induced change.
...
\ea
\label{introwilmsen1}\ili{MSA} ({Egyptian})\\
...
\ex \label{introwilmsen2}\ili{MSA} (\ili{Lebanese})\\
