...
Because this rule corresponds to the phonotactics of \ili{Aramaic} and is otherwise not found to the same degree except in \ili{Maghrebi} dialects (cf. Benkato, this volume),\ia{Benkato, Adam} pattern {replication} is likely, though cannot be proved.\footnote{Cf. Diem (\citeyear[47]{Diem1979}); Arnold \& Behnstedt (\citeyear[69--71]{ArnoldBehnstedt1993}); Weninger (\citeyear[748]{Weninger2011Aramaic}).}
