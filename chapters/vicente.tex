...
@book{Chalmeta2003,
	...
	title = {\textit{Invasión} \textit{e} \textit{islamización:} \textit{la} \textit{sumisión} \textit{de} \textit{Hispania} \textit{y} \textit{la} \textit{formación} \textit{de} \textit{al-Andalus}},
	year = {2003}
}
...
@book{Corriente1977,
	...
	title = {\textit{A} \textit{grammatical} \textit{sketch} \textit{of} \textit{the} \textit{{Spanish}} \textit{{Arabic}} \textit{dialect} \textit{bundle}},
	year = {1977}
}
...
@article{Corriente1978,
	author = {Corriente, Federico},
	journal = {\textit{Vox} \textit{Romanica}},
	pages = {214–218},
...
@article{Corriente1981,
	author = {Corriente, Federico},
	journal = {III. Los romancismos del Vocabulista. IV. Nuevos berberismos del hispano-árabe. \textit{Awrāq}},
	pages = {5–30},
	title = {Notas de lexicología hispanoárabe ({III} y {IV})},
	volume = {4},
	year = {1981}
}


Corriente, Federico. 1992. Linguistic interferences between Arabic and the Romance languages of the Iberian Peninsula. \textit{S.K.} \textit{Jayyusi} \textit{(ed.)} \textit{The} \textit{Legacy} \textit{of} \textit{Muslim} \textit{Spain}, 443–456. New York, Colonia: Brill.

@book{Corriente1992,
	address = {Madrid},
	author = {Corriente, Federico},
	publisher = {Editorial MAPFRE},
	title = {\textit{Arabe} \textit{andalusí} \textit{y} \textit{lenguas} \textit{romances}},
	year = {1992}
}
...
@article{Corriente1995,
	author = {Corriente, Federico},
	journal = {\textit{Revista} \textit{de} \textit{Filología} \textit{Española}},
	pages = {5–33},
	title = {El idiolecto romance andalusí reflejado por las xarajat},
	volume = {75},
	year = {1995}
}
...
@book{CorrienteCorriente2019,
	...
	series = {Encyclopédie linguistique d’Al-Andalus volume},
	sortname = {Corriente, Federico, Christophe Pereira and Angeles Vicente},
	title = {\textit{Dictionnaire} \textit{des} \textit{emprunts} \textit{ibéro-romans,} \textit{Emprunts} \textit{à} \textit{l’arabe} \textit{et} \textit{aux} \textit{langues} \textit{du} \textit{Monde} \textit{Islamique}},
	year = {2019}
}
...
@book{Dallet1982,
	...
	publisher = {SELAF},
	title = {\textit{Dictionnaire} \textit{kabyle-français,} \textit{français-kabyle}},
	year = {1982}
}
...
@article{Ferrando1995,
	...
	journal = {\textit{Anaquel} \textit{de} \textit{Estudios} \textit{Árabes}},
	pages = {71–86},
	title = {Los romancismos de los documentos mozárabes de Toledo},
	volume = {6},
	year = {1995}
}
...
@article{Ferrando1997,
	author = {Ferrando, Ignacio},
	journal = {Colin y los berberismos del árabe andalusí. \textit{Estudios} \textit{de} \textit{dialectología} \textit{norteafricana} \textit{y} \textit{andalusí,} \textit{EDNA}},
	pages = {105–146},
	title = {G. {{S}}},
	volume = {2},
	year = {1997}
...
@book{FierroBello2001,
	...
	publisher = {CIDOB ; Icaria},
	sortname = {Fierro Bello, Maria Isabel},
	title = {\textit{Al-Andalus:} \textit{saberes} \textit{e} \textit{intercambios} \textit{culturales}},
	year = {2001}
}
...
@book{GalmésdeFuentes1994,
	...
	title = {\textit{Las} \textit{jarchas} \textit{mozárabes}},
	year = {1994}
}


@book{Guichard1989,
	address = {\textit{En} \textit{torno} \textit{al} \textit{750} \textit{aniversario.} \textit{Antecedentes} \textit{y} \textit{consecuencias} \textit{de} \textit{la} \textit{conquista} \textit{de} \textit{Valencia}, 73–96. Valencia},
	author = {Guichard, Pierre},
	publisher = {Generalitat Valenciana},
	title = {Otra vez sobre un viejo problema: {{O}}rientalismo y occidentalismo en la civilización de la España Musulmana},
	year = {1989}
}


@book{Guichard1995,
	address = {Ed. facs. / estudio preliminar por Antonio Malpica Cuello. Granada},
	author = {Guichard, Pierre},
	publisher = {Servicio de Publicaciones de la Universidad},
	title = {\textit{Al-Andalus:} \textit{estructura} \textit{antropológica} \textit{de} \textit{una} \textit{sociedad} \textit{islámica} \textit{en} \textit{Occidente}},
	year = {1995}
}
