...
\ili{Late} Andalusi \ili{Arabic} (\citealt{CorrientePereiraVicente2015}: 233–234)\\
...
Andalusi \ili{Arabic} developed in the \ili{Iberian} Peninsula through intra-\ili{Arabic} \isi{leveling} and contact with two other language types: \ili{Romance} and \ili{Berber}. This situation spanned a long period of time and resulted in a good deal of contact-induced change. 
...
Future research would be particularly desirable with regard to contact-induced changes in Andalusi \ili{Arabic} due to the presence of \ili{Berber} varieties in the \ili{Iberian} Peninsula. This should involve collaboration between scholars of \ili{Berber} and of \ili{Arabic}. 

\section*{Further reading}

\citet{Corriente1997poetry} provides a linguistic analysis of Andalusian \isi{strophic} poetry.\\
\citet{Corriente2005} offers valuable information concerning the impact of Andalusi \ili{Arabic} on Ibero-\ili{Romance}.\\
\citet{CorrientePereiraVicente2015} is the most up-to-date book-length description of Andalusi \ili{Arabic} grammar. It contains a section dealing with \isi{transfer} from \ili{Romance} and \ili{Berber}.\\ 
\citet{Ferrando1997} offers an etymological description of some \ili{Berber} \isi{loanwords} in Andalusi \ili{Arabic}.\\ 
