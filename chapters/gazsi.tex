...
\citet{Gazsi2011} gives an overview of {Arabic}–Persian language contact from pre-Islamic times up to the modern era, also touching on {Arabic} dialects in Iran. A brief analysis of {Arabic} morphosyntactic features in {New Persian} is also provided.\\
