...
\item[/ḥ/\,>\,/ʔ/ occurring with occasional metathesis:] \textit{ṭaʔr} ‘plan’\,<\,\ili{MSA}/\ili{MSP} \textit{ṭarḥ} (\citealt{Ṣarrāfī1996}: 137), \textit{maʔla} ‘city quarter’\,<\,\ili{MSA}/\ili{MSP} \textit{maḥalla} (\citealt{Ṣarrāfī1996}: 188), \textit{maʔala} ‘city quarter’ (\citealt{NaǧībiFīni2002}: 133).
...
\item[Word-final /b/ and /f/\,>\,/m/:] \textit{naǧīm} ‘noble’\,<\,\ili{MSA}/\ili{MSP} \textit{naǧīb} (\citealt{Īzadpanāh2001}: 193), \textit{niṣm} ‘half’\,<\,\ili{MSA}/\ili{MSP} \textit{niṣf} (\citealt{Īzadpanāh2001}: 195).
...
\item[Medial and word-final /b/ > /v/:] in \ili{Baḫtiārī}, \textit{ādāv} ‘customs’ < \ili{MSA}\slash\ili{MSP} \textit{ādāb} \citep[15]{Sarlak2002}, \textit{ʕajīv} ‘strange’ < \ili{MSA}\slash\ili{MSP} \textit{ʕajīb} \citep[25]{Sarlak2002}, \textit{qavīla} ‘tribe’~< \ili{MSA}/\ili{MSP} \textit{qabīla} \citep[199]{Sarlak2002}.
