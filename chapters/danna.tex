...
Borrowing does not involve plural morphemes only, but other classes as well. In Mazara del Vallo, for instance, young speakers occasionally use the Sicilian diminutive morpheme \textit{{}-eddru} with Arabic names, creating morphological hybrids of the kind illustrated in  \REF{ex:key:maz1} : 
