...
The figures in Table \ref{tab:nigeria:1} are probably a slight underestimation, as there are about sixty words, like \textit{bazingir} ‘soldier of \iai{Rabeh}’ which clearly are not of Arabic origin but whose precise origin has not been found.
...
\begin{tabularx}{.66\textwidth}{lllll} 
\lsptoprule
