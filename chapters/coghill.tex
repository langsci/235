...
\ea\label{ex:coghill:}
\langinfo{}{}{\label{bkm:Ref534224242}Christian Telkepe NENA (author’s fieldwork)}\\
\gll zi-napl-ɒ\\
     \textsc{prsp-}fall.\textsc{pres}{}-\textsc{2sg.f}\\
\glt ‘She’s going to fall.’\z

\ea\label{ex:coghill:}
\langinfo{}{}{\label{bkm:Ref534224256}Christian Mosul Arabic (author’s fieldwork)}\\
...
\ea\label{ex:coghill:}
\langinfo{}{}{\label{bkm:Ref534225045}Iraqi Arabic}\\
...
\ea\label{ex:coghill:}
\langinfo{}{}{\label{bkm:Ref534225057}Jewish Zakho NENA}\\
...
\ea\label{ex:coghill:}
\langinfo{}{}{\label{bkm:Ref534225894}Akre Kurdish \citep[175]{MacKenzie1961}}\\
\gll ew kî꞊e \textup{[æw kiːæ]}\\
     \textsc{dem} who꞊\textsc{prs.cop.3sg}\\
\glt ‘Who is that?’ (transcription adapted to standard)\z

\ea\label{ex:coghill:}
\langinfo{}{}{Christian Telkepe NENA (author’s fieldwork)}\\
\gll man꞊ilə\\
     who꞊\textsc{prs.cop.3sg.m}\\
\glt ‘Who is he?’\z

\ea\label{ex:coghill:}
\langinfo{}{}{\label{bkm:Ref534225903}Jewish Arbel Arabic (\citealt{Jastrow1990}: 37, 46)} \\
\gll mani꞊we\\
     who꞊\textsc{3sg.m}\\
\glt ‘Who is he?’\z
...
\ea\label{ex:coghill:}
\langinfo{}{}{\label{bkm:Ref534226048}Christian Telkepe NENA}\\
\gll k-əbə       d-āxəl\\
...
Most work on NENA and language contact has focused on contact with Kurdish. To my knowledge, only three works are dedicated to contact with Arabic, none of which is an overview: \citegen{Sabar1984} study of Arabic influence in the early texts in Jewish Lišāna Deni, Coghill’s (2010b, 2012) research into a prospective construction found in the Christian Nineveh Plain dialects which has apparently grammaticalized under influence from Arabic, and \citegen{Coghill2015} study of new verbal derivations borrowed from Arabic into various Neo-Aramaic languages, including NENA.

\citegen{Khan2002} grammar of Christian Qaraqosh contains a great deal of information, scattered through the volume, about contact influences from Arabic, Qaraqosh being one of the dialects most affected by such influence.
...
% 	title = {\textit{Communal} \textit{Dialects} \textit{in} \textit{Baghdad}, \textit{Harvard} \textit{Middle} \textit{{Eastern}} \textit{Monographs}},
% 	year = {1964}
% }
% 
...
% 	title = {\textit{The} \textit{{Jews}} \textit{of} \textit{Kurdistan}, \textit{{Jewish}} \textit{{Folklore}} \textit{and} \textit{Anthropology} \textit{series}},
% 	year = {1993}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Bulut2007,
% 	address = {N. Postgate, 159–187. London},
% 	author = {Bulut, Christiane},
% 	publisher = {British School of Archaeology in Iraq},
% 	title = {"{Iraq}i Turkman." In \textit{Languages} \textit{of} \textit{{Iraq},} \textit{Ancient} \textit{and} \textit{Modern}, edited by J},
% 	year = {2007}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	note = {Brill.},
% 	publisher = {E.J},
% 	title = {"{Neo}-Aramaic and {Kurdish}: {{A}}n Interdisciplinary Consideration of Their Influence on Each Other." In \textit{Language} \textit{and} \textit{Culture} \textit{in} \textit{the} \textit{Near} \textit{{East}}, edited by {Shlomo} Izre'el and Rina Drory, 219–252},
% 	year = {1995}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	title = {\textit{{Kurdish}-{English}} \textit{dictionary} \textit{=} \textit{Ferhenga} \textit{Kurmancî-Inglîzî}, \textit{{Yale}} \textit{language} \textit{series}},
% 	year = {2003}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	note = {" PhD, Faculty of Oriental Studies, University of Cambridge.},
...
% 	title = {"The Morphology and Distribution of Noun Plurals in the {Neo}-Aramaic Dialect of Alqosh." In \textit{Studi} \textit{Afroasiatici.} \textit{{XI}} \textit{Incontro} \textit{Italiano} \textit{di} \textit{Linguistica} \textit{Camitosemitica}, edited by Alessandro Mengozzi, 337–348},
% 	year = {2005}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	title = {"Some Notable Features in {North}-{Eastern} {{{Neo}}}-Aramaic Dialects of {Iraq}." In \textit{{{{Neo}}}-Aramaic} \textit{Dialect} \textit{Studies:} \textit{Proceedings} \textit{of} \textit{a} \textit{Workshop} \textit{on} \textit{{{{Neo}}}-Aramaic} \textit{held} \textit{in} \textit{\citealt{Cambridge2005}}, edited by Geoffrey Khan, 91–104},
% 	year = {2008}
% }
% 
% \end{styleEndNoteBibliography}
...
% @article{Coghill2009,
% 	author = {Coghill, Eleanor},
% 	journal = {"Four Versions of a Neo-Aramaic Children’s Story."  \textit{ARAM}},
% 	note = {. doi: 10.2143/ARAM.095.},
% 	pages = {251–280},
% 	urldate = {21.0.2047},
% 	volume = {21},
% 	year = {2009}
...
% 	address = {doi},
% 	author = {Coghill, Eleanor},
% 	note = {1075/dia.27.3.01cog.},
% 	publisher = {10},
% 	title = {"The grammaticalization of prospective aspect in a group of {Neo}-Aramaic dialects."  \textit{Diachronica} 27 \{REF}{ex: {{K}}ey:3}:359–410},
% 	year = {2010b}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	title = {"Parallels in the Grammaticalisation of {Neo}-Aramaic \textit{zil}{}- and {Arabic} \textit{raḥ}{}- and a Possible Contact Scenario." In \textit{Grammaticalization} \textit{in} \textit{{Semitic}}, edited by Domenyk Eades, 127–144},
% 	year = {2012}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	address = {doi},
% 	author = {Coghill, Eleanor},
% 	note = {1515/ling-2013-0065.},
% 	publisher = {DOI 10},
% 	title = {"Differential object marking in {Neo}-Aramaic."  \textit{Linguistics} 52 \{REF}{ex: {{K}}ey:2}:335–364},
% 	year = {2014}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	title = {"Borrowing of verbal derivational morphology between {Semitic} languages: {{T}}he case of {Arabic} verb derivations in {Neo}-Aramaic." In \textit{Borrowed} \textit{Morphology}, edited by Francesco Gardani, Peter Arkadiev and Nino Amiridze, 83–108},
% 	year = {2015}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	title = {\textit{A} \textit{short} \textit{reference} \textit{grammar} \textit{of} \textit{Iraqi} \textit{{{Arabic}}}, \textit{Georgetown} \textit{classics} \textit{in} \textit{{{Arabic}}} \textit{language} \textit{and} \textit{linguistics}},
% 	year = {1964}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Fassberg2010,
% 	address = {Edited by Hezy Mutzafi, C.H.M. Versteegh and Aaron Rubin, D., \textit{Studies} \textit{in} \textit{Semitic} \textit{Languages} \textit{and} \textit{Linguistics}. Leiden/Boston},
...
% 	publisher = {Gorgias Press},
% 	title = {\textit{The} \textit{{{Neo}}-Aramaic} \textit{dialect} \textit{of} \textit{Bohtan}, \textit{Gorgias} \textit{{{Neo}}-Aramaic} \textit{studies,}},
% 	year = {2009}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Garbell1965,
% 	address = {"The impact of Kurdish and Turkish on the Jewish Neo-Aramaic dialect of Persian Azerbaijan and the adjoining régions."  \textit{Journal} \textit{of} \textit{the} \textit{American} \textit{Oriental} \textit{Society} 85 \REF{ex:coghill:2}},
...
% 	publisher = {Brill},
% 	title = {\textit{The} \textit{{Jewish}} \textit{{Neo}-Aramaic} \textit{dialect} \textit{of} \textit{Amǝdya}, \textit{Studies} \textit{in} \textit{{Semitic}} \textit{languages} \textit{and} \textit{linguistics}},
% 	year = {2011}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	title = {\textit{The} \textit{Syntax} \textit{and} \textit{Semantics} \textit{of} \textit{Verb} \textit{Morphology} \textit{in} \textit{Modern} \textit{Aramaic} \textit{:} \textit{a} \textit{{Jewish}} \textit{Dialect} \textit{of} \textit{Iraqi} \textit{Kurdistan}, \textit{{American}} \textit{Oriental} \textit{Society} \textit{(series)}},
% 	year = {1989}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Hobrack2000,
% 	address = {"Der neuaramäische Dialekt von Umra (Dereköyü)},
% 	author = {Hobrack, Sebastian},
% 	note = {" Magister Magisterarbeit, Philosophischen Fakultät II (Sprach- und Literaturwissenschaften), Friedrich-Alexander-Universität Erlangen-Nürnberg.},
% 	publisher = {Laut- und Formenlehre - Texte - Glossar},
% 	year = {2000}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Jastrow1978,
% 	address = {1. Aufl. ed. 2 vols. Vol. 1, \textit{Abhandlungen} \textit{für} \textit{die} \textit{Kunde} \textit{des} \textit{Morgenlandes} \textit{43:4}. Wiesbaden},
% 	author = {Jastrow, Otto},
% 	publisher = {Steiner},
% 	title = {\textit{Die} \textit{mesopotamisch-arabischen} \textit{Qəltu-{Dialekte}.} \textit{Band} \textit{I:} \textit{Phonologie} \textit{und} \textit{Morphologie}},
% 	year = {1978}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Jastrow1979,
% 	address = {"Zur arabischen Mundart von Mossul."  \textit{Zeitschrift} \textit{für} \textit{arabische} \textit{Linguistik} \REF{ex:coghill:2}},
% 	author = {Jastrow, Otto},
% 	publisher = {36-75},
% 	year = {1979}
% }
...
% \begin{styleEndNoteBibliography}
% @book{Jastrow1981,
% 	address = {1. Aufl. ed. 2 vols. Vol. 2, \textit{Abhandlungen} \textit{für} \textit{die} \textit{Kunde} \textit{des} \textit{Morgenlandes} \textit{46:1}. Wiesbaden},
% 	author = {Jastrow, Otto},
% 	publisher = {Steiner},
% 	title = {\textit{Die} \textit{mesopotamisch-arabischen} \textit{Qəltu-{Dialekte}.} \textit{Band} \textit{{II}:} \textit{Volkskundliche} \textit{Texte} \textit{in} \textit{elf} \textit{{Dialekte}n}},
% 	year = {1981}
% }
% 
% \end{styleEndNoteBibliography}
...
% @misc{Jastrow1983,
% 	author = {Jastrow, Otto},
% 	note = {"Tikrit Arabic verb morphology in a comparative},
% 	year = {1983}
% }
% 
% \end{styleEndNoteBibliography}
% 
% \begin{styleEndNoteBibliography}
% perspective."  \textit{Al-Abhath} 31:99–110.
% \end{styleEndNoteBibliography}
% 
% \begin{styleEndNoteBibliography}
% @book{Jastrow1990,
...
% 	title = {\textit{Der} \textit{arabische} \textit{{Dialekt}} \textit{der} \textit{{Juden}} \textit{von} \textit{ʿAqra} \textit{and} \textit{Arbīl}, \textit{Semitica} \textit{Viva}},
% 	year = {1990}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Joseph2009,
% 	address = {\textit{The} \textit{Synchrony} \textit{and} \textit{Diachrony} \textit{of} \textit{the} \textit{Balkan} \textit{Infinitive:} \textit{A} \textit{Study} \textit{in} \textit{Areal,} \textit{General} \textit{and} \textit{Historical} \textit{Linguistics.} Cambridge, UK},
...
% 	publisher = {Brill},
% 	title = {\textit{A} \textit{Grammar} \textit{of} \textit{{Neo}-Aramaic:} \textit{The} \textit{Dialect} \textit{of} \textit{the} \textit{{Jews}} \textit{of} \textit{Arbel}, \textit{Handbook} \textit{of} \textit{Oriental} \textit{Studies.} \textit{\sectref{sec: {{K}}ey:1} The Near and Middle {East}}},
% 	year = {1999}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Khan2002,
% 	address = {Edited by T. Muraoka and C.H.M. Versteegh, \textit{Studies} \textit{in} \textit{Semitic} \textit{Languages} \textit{and} \textit{Linguistics}. Leiden},
% 	author = {Khan, Geoffrey},
% 	publisher = {Brill},
% 	title = {\textit{The} \textit{{Neo}-Aramaic} \textit{Dialect} \textit{of} \textit{Qaraqosh}},
% 	year = {2002}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	author = {Khan, Geoffrey},
% 	publisher = {Mouton},
% 	title = {"Grammatical borrowing in {North}-eastern {Neo}-Aramaic." In \textit{Grammatical} \textit{Borrowing} \textit{in} \textit{Cross-Linguistic} \textit{Perspective}, edited by Yaron Matras and Jeanette Sakel, 197–214},
% 	year = {2007}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Khan2008,
% 	address = {Edited by W.H. van Soldt. 3 vols, \textit{Handbook} \textit{of} \textit{Oriental} \textit{Studies,} \textit{Section} \textit{One:} \textit{The} \textit{Near} \textit{and} \textit{Middle} \textit{East}. Leiden},
% 	author = {Khan, Geoffrey},
% 	publisher = {Brill},
% 	title = {\textit{The} \textit{{Neo}-Aramaic} \textit{Dialect} \textit{of} \textit{Barwar}},
% 	year = {2008}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Khan2009,
% 	address = {Edited by Geoffrey Khan and Hezy Mutzafi, \textit{Gorgias} \textit{Neo-Aramaic} \textit{Studies}. Piscataway, NJ},
% 	author = {Khan, Geoffrey},
% 	publisher = {Gorgias Press},
% 	title = {\textit{The} \textit{{Jewish}} \textit{{Neo}-Aramaic} \textit{Dialect} \textit{of} \textit{{Sanandaj}}},
% 	year = {2009}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	journal = {"Kān ya ma kān: sur quelques emplois de madans les dialectes arabes du Moyen-Orient."  \textit{Studia} \textit{Orientalia} \textit{Electronica}},
% 	pages = {151--162},
...
% \begin{styleEndNoteBibliography}
% @book{MacKenzie1961,
% 	address = {2 vols. London, New York,},
...
% 	title = {\textit{Grammar} \textit{of} \textit{the} \textit{dialects} \textit{of} \textit{vernacular} \textit{Syriac} \textit{as} \textit{spoken} \textit{by} \textit{the} \textit{eastern} \textit{Syrians} \textit{of} \textit{Kurdistan,} \textit{north-west} \textit{Persia,} \textit{and} \textit{the} \textit{Plain} \textit{of} \textit{Mosul} \textit{:} \textit{with} \textit{notices} \textit{of} \textit{the} \textit{vernacular} \textit{of} \textit{the} \textit{jews} \textit{of} \textit{{Azerbaijan}} \textit{and} \textit{of} \textit{Zakhu} \textit{near} \textit{Mosul} \textit{by} \textit{Arthur} \textit{{John}} \textit{Maclean}},
% 	year = {1895}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	title = {\textit{A} \textit{dictionary} \textit{of} \textit{the} \textit{dialects} \textit{of} \textit{vernacular} \textit{Syriac} \textit{as} \textit{spoken} \textit{by} \textit{the} \textit{{Eastern}} \textit{Syrians} \textit{of} \textit{Kurdistan,} \textit{northwest} \textit{Persia,} \textit{and} \textit{the} \textit{plain} \textit{of} \textit{Moṣul}},
% 	year = {1901}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Matras2009,
% 	address = {\textit{Language} \textit{contact}},
% 	author = {Matras, Yaron},
% 	publisher = {Cambridge University Press},
% 	year = {2009}
% }
...
% \begin{styleEndNoteBibliography}
% @book{Mengozzi2002,
% 	address = {2 vols. Vol. II, \textit{Corpus} \textit{Scriptorum} \textit{Christianorum} \textit{Orientalium}. Lovanii},
% 	author = {Mengozzi, Alessandro},
% 	publisher = {Peeters},
% 	title = {\textit{{Israel}} \textit{of} \textit{Alqosh} \textit{and} \textit{{Joseph}} \textit{of} \textit{Telkepe.} \textit{A} \textit{Story} \textit{in} \textit{a} \textit{Truthful} \textit{Language:} \textit{Religious} \textit{Poems} \textit{in} \textit{Vernacular} \textit{Syriac} \textit{({North}} \textit{{Iraq},} \textit{17th} \textit{century).} \textit{Vol.} \textit{{II}:} \textit{Introduction} \textit{and} \textit{Translation}},
% 	year = {2002}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Mutzafi2004,
% 	address = {Edited by Otto Jastrow, \textit{Semitic} \textit{Viva}. Wiesbaden},
% 	author = {Mutzafi, Hezy},
% 	note = {Revised thesis (doctoral), - Tel Aviv University, 2000.},
% 	publisher = {Harrassowitz},
% 	title = {\textit{The} \textit{{Jewish}} \textit{{Neo}-Aramaic} \textit{dialect} \textit{of} \textit{Koy} \textit{Sanjaq} \textit{(Iraqi} \textit{Kurdistan)}},
% 	year = {2004}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Mutzafi2008,
% 	address = {Edited by Otto Jastrow, \textit{Semitica} \textit{Viva}. Wiesbaden},
% 	author = {Mutzafi, Hezy},
% 	publisher = {Harrassowitz},
% 	title = {\textit{The} \textit{{Jewish}} \textit{{Neo}-Aramaic} \textit{Dialect} \textit{of} \textit{Betanure} \textit{(Province} \textit{of} \textit{{Dihok})}},
% 	year = {2008}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	sortname = {Noldeke, Theodor},
% 	title = {\textit{Compendious} \textit{Syriac} \textit{Grammar}},
% 	year = {1904}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	note = {Onen.},
% 	publisher = {M. F},
% 	title = {\textit{Dictionary} \textit{Ferheng} \textit{{{Kurdish}}-{{English}}} \textit{{{English}}-{{Kurdish}}} \textit{(kurmancî)}},
% 	year = {1993}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Sabar1976,
% 	address = {\textit{Pəšaṭ} \textit{Wayəhî} \textit{Bəšallaḥ,} \textit{A} \textit{Neo-Aramaic} \textit{Midrash} \textit{on} \textit{Beshallaḥ} \textit{(Exodus):} \textit{Introduction,} \textit{Phonetic} \textit{Transcription,} \textit{Translation,} \textit{Notes,} \textit{and} \textit{Glossary.} Wiesbaden},
% 	author = {Sabar, Yona},
...
% \begin{styleEndNoteBibliography}
% @book{Sabar1978,
% 	address = {"Multilingual Proverbs in the Neo-Aramaic Speech of the Jews of Zakho, Iraqi Kurdistan."  \textit{International} \textit{Journal} \textit{of} \textit{Middle} \textit{East} \textit{Studies} 9 \REF{ex:coghill:2}},
% 	author = {Sabar, Yona},
% 	publisher = {215–235},
% 	year = {1978}
% }
...
% \begin{styleEndNoteBibliography}
% @book{Sabar1984,
% 	address = {"The Arabic Elements in the Jewish Neo-Aramaic Texts of Nerwa and ʿAmādīya, Iraqi Kurdistan."  \textit{Journal} \textit{of} \textit{the} \textit{American} \textit{Oriental} \textit{Society} 104 \REF{ex:coghill:1}},
% 	author = {Sabar, Yona},
% 	publisher = {201–211},
% 	year = {1984}
% }
...
% 	title = {"General {European} Loanwords in the {Jewish} {{Neo}}-Aramaic Dialect of {Zakho}, Iraqi Kurdistan." In \textit{Studies} \textit{in} \textit{{{Neo}}-Aramaic}, edited by Wolfhart Heinrichs, 53–66},
% 	year = {1990}
% }
% 
% \end{styleEndNoteBibliography}
...
% 	author = {Sabar, Yona},
% 	publisher = {Harrassowitz},
% 	title = {\textit{A} \textit{{Jewish}} \textit{{Neo}-Aramaic} \textit{Dictionary:} \textit{Dialects} \textit{of} \textit{Amidya,} \textit{{Dihok},} \textit{{Nerwa}} \textit{and} \textit{{Zakho},} \textit{northwestern} \textit{{Iraq}}, \textit{Semitica} \textit{Viva}},
% 	year = {2002}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Segal1955,
% 	address = {"Neo-Aramaic Proverbs of the Jews of Zakho."  \textit{Journal} \textit{of} \textit{Near} \textit{Eastern} \textit{Studies} 14 \REF{ex:coghill:4}},
...
% 	title = {\textit{Der} \textit{neuostaramäische} \textit{{Dialekt}} \textit{von} \textit{Bēṣpən} \textit{(Provinz} \textit{Mardin,} \textit{Südosttürkei):} \textit{eine} \textit{grammatische} \textit{{Darstellung}}},
% 	year = {2000}
% }
% 
% \end{styleEndNoteBibliography}
...
% \begin{styleEndNoteBibliography}
% @book{Talay2011,
% 	address = {"Arabic dialects of Mesopotamia."  \textit{The} \textit{Semitic} \textit{Languages:} \textit{An} \textit{International} \textit{Handbook}},
% 	author = {Talay, Shabo},
% 	publisher = {909-920},
% 	year = {2011}
% }
...
% 
% \begin{styleEndNoteBibliography}
% @book{WoodheadStowasser1967,
% 	address = {"A Dictionary of Iraqi Arabic},
% 	author = {Woodhead, Daniel R, Wayne Beene, and Karl Stowasser},
% 	note = {"},
